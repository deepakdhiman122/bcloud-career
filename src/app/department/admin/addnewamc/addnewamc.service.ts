...
export class AddnewamcService {

  constructor(private httpclient: HttpClient) { }

  saveproduct(jsondata: any) {
    const url = environment.apiBase + '/productcontroller/saveamcservices';
  ...
  updateProduct(jsondata: any) {
    const url = environment.apiBase + '/productcontroller/updateamcservices';
    const headers = new HttpHeaders({ 'Content-Type': 'application/json;' });
    return this.httpclient.post<any>(url, jsondata, { headers: headers });
  }
